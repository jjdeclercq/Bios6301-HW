...
**JC Grading -5 for questions 1 and 2**
Outcome for treatments should be 5 greater in group one.  Consider something like the slightly modified code below:
...
**JC Grading -2**
Looking for a single generated dataset (rather than running through loop).
...
**JC Comment**
I think the PDF output looks fine.
